...
import { TForwardRefFunctions, TStyleVariables } from "../../interafaces/units";
const View = React.forwardRef<TForwardRefFunctions, ITableView>(
  (
    {
      numberOfRows,
      usePagination,
    ...
    React.useEffect(() => {
      if (!mounted || preventAutoScroll) return;
      if (tableRef.current) {
